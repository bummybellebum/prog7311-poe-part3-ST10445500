...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GLMS.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GLMS.Models.ContractDocument", b =>
                {
            ...
            modelBuilder.Entity("GLMS.Models.ContractStatus", b =>
                {
                    b.Property<int>("ContractStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GLMS.Models.ServiceRequestStatus", b =>
                {
                    b.Property<int>("ServiceRequestStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GLMS.Models.Contract", b =>
                {
                    ...
                    b.HasOne("GLMS.Models.ContractStatus", "ContractStatus")
                        .WithMany("Contracts")
                        .HasForeignKey("ContractStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GLMS.Models.ApplicationUser", "CreatedByUser")
            ...
            modelBuilder.Entity("GLMS.Models.ContractDocument", b =>
                {
                    ...
                    b.HasOne("GLMS.Models.ApplicationUser", "UploadedByUser")
            ...
            modelBuilder.Entity("GLMS.Models.ServiceRequest", b =>
                {
                    ...
                    b.HasOne("GLMS.Models.ApplicationUser", "RequestedByUser")
                        .WithMany("ServiceRequests")
                        .HasForeignKey("RequestedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GLMS.Models.ServiceRequestStatus", "ServiceRequestStatus")
                        .WithMany("ServiceRequests")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GLMS.Models.ApplicationUser", null)
                        .WithMany()
