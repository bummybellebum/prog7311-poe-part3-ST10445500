...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GLMS.Api.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GLMS.Api.Models.ContractDocument", b =>
                {
            ...
            modelBuilder.Entity("GLMS.Api.Models.ContractStatus", b =>
                {
                    b.Property<int>("ContractStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GLMS.Api.Models.ServiceRequestStatus", b =>
                {
                    b.Property<int>("ServiceRequestStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GLMS.Api.Models.Contract", b =>
                {
                    ...
                    b.HasOne("GLMS.Api.Models.ContractStatus", "ContractStatus")
                        .WithMany("Contracts")
                        .HasForeignKey("ContractStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GLMS.Api.Models.ApplicationUser", "CreatedByUser")
            ...
            modelBuilder.Entity("GLMS.Api.Models.ContractDocument", b =>
                {
                    ...
                    b.HasOne("GLMS.Api.Models.ApplicationUser", "UploadedByUser")
            ...
            modelBuilder.Entity("GLMS.Api.Models.ServiceRequest", b =>
                {
                    ...
                    b.HasOne("GLMS.Api.Models.ApplicationUser", "RequestedByUser")
                        .WithMany("ServiceRequests")
                        .HasForeignKey("RequestedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GLMS.Api.Models.ServiceRequestStatus", "ServiceRequestStatus")
                        .WithMany("ServiceRequests")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GLMS.Api.Models.ApplicationUser", null)
                        .WithMany()
